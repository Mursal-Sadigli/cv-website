  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gray-50'>
        ...
        <form onSubmit={handleSubmit} className="sm:w-[350px] w-full text-center border border-gray-300/60 rounded-2xl px-8 bg-white">
                ...
                {state !== "login" && (
                    <div className="flex items-center mt-6 w-full bg-white h-12 rounded-full overflow-hidden px-4 gap-2 focus-within:border-2 focus-within:border-blue-500">
                ...
                <div className="flex items-center w-full mt-4 bg-white h-12 rounded-full overflow-hidden px-4 gap-2 focus-within:border-2 focus-within:border-blue-500">
                ...
                <div className="flex items-center mt-4 w-full bg-white h-12 rounded-full overflow-hidden px-4 gap-2 focus-within:border-2 focus-within:border-blue-500">
