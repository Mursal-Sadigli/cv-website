...
const Testimonial = () => {
  ...
  return (
    <>
     <div id='testtimonials' className='flex flex-col items-center my-10 scroll-mt-12'>
         ...
         <div className="flex items-center gap-2 text-sm text-green-600 bg-green-400/10 border rounded-full px-6 py-1.5">
            ...
            <span>İstifadəçi rəyləri</span>
        </div>
        <Title 
    title="Yalnız sözlərimizə inanmayın" 
    description="İstifadəçilərimizin bizə nə dediyini dinləyin. Həmişə özümüzü yaxşılaşdırmaq yolları axtarırıq. Əgər bizimlə müsbət təcrübəniz varsa, rəyinizi paylaşın."
/>
</div>
