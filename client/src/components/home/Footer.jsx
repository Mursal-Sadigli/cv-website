...
const Footer = () => {
  return (
    <>
      <footer className="flex flex-col lg:flex-row justify-between overflow-hidden gap-10 md:gap-20 py-16 px-6 md:px-16 lg:px-24 xl:px-32 text-[13px] bg-gradient-to-r from-white via-green-200/60 to-white mt-40 relative transition-colors">
        {/* Product və Resources bölmələri qarşı-qarşıya */}
        <div className="flex gap-15 items-start">
          {/* Product bölməsi */}
          <div className="w-auto text-left ml-6 sm:ml-10 md:ml-16 lg:ml-20">
          ...
          {/* Resources bölməsi */}
          <div className="w-auto text-left ml-32 sm:ml-44 md:ml-56 lg:ml-72">
        ...
        {/* Aşağı sağ tərəfə - daha sağda */}
        <div className="w-full lg:w-auto lg:absolute lg:bottom-4 lg:right-16 xl:right-20 mt-10 lg:mt-0">
          <div className="flex flex-col max-md:items-center max-md:text-center gap-2 items-end lg:items-end">
            <p className="max-w-60 text-right lg:text-right">Making every customer feel valued—no matter the size of your audience.</p>
            <div className="flex items-center gap-4 mt-3 lg:justify-end">
            ...
            <p className="mt-3 text-center lg:text-right">© 2026 CVBuilder</p>
          </div>
        </div>
      </footer>
