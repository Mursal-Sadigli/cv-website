    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500">
            İş təcrübənizi əlavə edin
          </p>
        </div>
        <button onClick={addExperience} className="flex items-center gap-2 px-3 py-1 text-sm bg-purple-100 text-purple-700 rounded-lg hover:bg-green-200 transition-colors ">
      ...
      {data.length === 0 ? (
        <div className="text-center py-8 text-gray-500">
            ...
            <p>İş təcrübəsi hələ əlavə olunmayıb</p>
            <p className="text-sm">Başlamaq üçün ‘Təcrübə əlavə et’ düyməsini kliklə</p>
        </div>
      ): (
            ...
            {data.map((experience, index) => (
                <div key={index} className="p-4 border border-gray-200 rounded-lg space-y-3">
                    ...
                    <div className="grid md:grid-cols-2 gap-3">
                        ...
                        <input value={experience.company || ""} onChange={(e) => updatedExperience(index, "company", e.target.value)} type="text" placeholder="Şirkət adı" className="px-3 py-2 text-sm rounded-lg" />
                        <input value={experience.position || ""} onChange={(e) => updatedExperience(index, "position", e.target.value)} type="text" placeholder="Vəzifə adı" className="px-3 py-2 text-sm rounded-lg" />
                    ...
                    <label className="flex items-center gap-2">
                        ...
                        <span className="text-sm text-gray-700">Hal-hazırda bu iş yerində çalışıram</span>
                    </label>

                    <div className="space-y-2">
                        <div className="flex items-center justify-between">
                            <label className="text-sm font-medium text-gray-700">İşin təsviri</label>
                        ...
                        placeholder="Əsas vəzifələrinizi və nailiyyətlərinizi təsvir edin..." />
                    </div>
                </div>
            ))}
        </div>
